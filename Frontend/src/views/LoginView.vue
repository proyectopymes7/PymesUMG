...
<template>
  <div class="min-h-screen pt-24 pb-12 flex items-center justify-center bg-slate-50 relative overflow-hidden">
    <!-- Decorative background elements -->
    <div class="absolute top-0 right-0 w-96 h-96 bg-fiery-red/5 rounded-full blur-3xl translate-x-1/2 -translate-y-1/2"></div>
    <div class="absolute bottom-0 left-0 w-96 h-96 bg-fiery-navy/5 rounded-full blur-3xl -translate-x-1/2 translate-y-1/2"></div>
    
    <div class="w-full max-w-md mx-auto z-10 px-6">
      <div class="bg-white rounded-[2rem] shadow-2xl border border-slate-100 p-8 md:p-10 relative overflow-hidden">
        ...
        <div class="text-center mb-10">
          ...
          <h1 class="text-2xl md:text-3xl font-black text-fiery-navy tracking-tight font-outfit uppercase mb-2">Bienvenido de <span class="text-fiery-red">vuelta</span></h1>
